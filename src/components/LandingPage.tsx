    ...
    <div className="landing-page">
      <div className="landing-container">
        ...
        <div className="welcome-section">
          <h2>Welcome to GitMacher Career Portal</h2>
          <p className="welcome-description">
            Join our innovative team and help shape the future of version control and collaboration. 
            Choose your path below to continue your journey with GitMacher.
          </p>
        </div>
        ...
        <div className="action-cards">
          <div className="action-card interview-card">
            ...
            <div className="card-content">
              ...
              <p>
                New to GitMacher? Start your application process with our virtual technical interview. 
              ...
              <ul className="card-features">
                ...
                <li><i className="fas fa-user-check"></i> No prior experience with GitMacher needed</li>
              </ul>
            </div>
            <button 
        ...
        <div className="info-section">
          <div className="info-box">
            ...
            <div className="info-item">
              ...
              <div>
                <h4>Need Help?</h4>
                <p>Contact us at <a href="mailto:support@gitmacher.com">support@gitmacher.com</a></p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="process-flow">
          <h3>GitMacher Hiring Process</h3>
        ...
        <footer className="landing-footer">
          <p>&copy; 2025 GitMacher. All rights reserved. | Revolutionizing Version Control</p>
        </footer>
      </div>
    </div>
  );
